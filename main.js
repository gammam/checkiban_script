...
const myOptions = 'hello'
myCheckiban.fromCsvToCsv(inputFile,2,100,outputFile,{flags:'w'});

for (let step = 1; step < max_rows; step++) {
    // Runs 5 times, with values of step 0 through 4.
    var firstStep = (step)*max_concurrent_requests+1;
    var lastStep = firstStep+max_concurrent_requests-1;
    
    setTimeout(myCheckiban.fromCsvToCsv,delay_ms*step,inputFile,firstStep,lastStep,outputFile,{flags:'a'})
